...
import { Shield, Award, DollarSign, BarChart3, FileCheck, AlertCircle, Loader2, Copy, Check, Wallet, TrendingDown, Zap, Clock, TrendingUp } from 'lucide-react';
...
function ActiveSessionsPanel({ agentAddress }: { agentAddress: string }) {
...
export default function AgentDashboard() {
  ...
  const stats = [
    ...
    { icon: DollarSign, gradient: 'from-emerald-500/15 to-green-500/15', iconColor: 'text-emerald-400', label: 'Total Revenue', value: `$${((reputation?.totalRevenue || 0) / 1_000_000).toFixed(2)}` },
